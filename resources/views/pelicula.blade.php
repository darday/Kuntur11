                ...
                <div class="card-body" style="background-color: #4d4d4d">
                    ...
                    <div class="row " style="margin-bottom: 10vh; padding-top:5vh">
                        ...
                        <div class="col-12 col-sm-12 col-md-6 col-lg-6 col-xl-6 text-left animate__animated animate__fadeIn">
                            ...
                            <p style="color: white"><b style="font-weight: bold">Sinopsis:</b> {{$film->film_Descripcion}} </p><br>
                            <p style="color: white; margin-bottom:0 !important"><b  style="font-weight: bold">Fecha de Proyección:</b> {{$film->film_Anio}}</p>
                            <p style="color: white; margin-bottom:0 !important"><b  style="font-weight: bold">Hora:</b> {{$film->film_Duracion}}</p>
                            <p style="color: white;margin-bottom:0 !important"><b  style="font-weight: bold">Lugar:</b> {{$film->film_Ciudad}} </p>
                            <hr>
